...
//   async onDisplayNotification(url)
//   {
...
//    * 保存当前图片到本地相册
//    */
//    public hasAndroidPermission = async()=>
//    {
...
//   public saveToLocal = async ():Promise<void> =>
//   {
...
//       const valid = CommonHelper.isUrl(this.props.imageUrls[this.state.currentShowIndex || 0].url);
...
//       if (valid)
//       {
//           const newPath = `${dirs.LegacyDownloadDir}/save_img_${Math.random()}.png`;
//           ReactNativeBlobUtil.config({
//               path: newPath,
//               //   fileCache: true,
//               //   appendExt: 'png',
//           })
//               .fetch('GET', this.props.imageUrls[this.state.currentShowIndex || 0].url)
//               .catch(error => console.log(error,'err'));
//           imgSource = 'file://' + newPath;
//           this.onDisplayNotification(newPath);
//       }
//       else
//       {

//           if (this.props.imageUrls[this.state.currentShowIndex || 0].url.includes('data:image/png;base64'))
//           {
//               const Base64Code = this.props.imageUrls[this.state.currentShowIndex || 0].url.split('data:image/png;base64,'); // base64Image is my image base64 string

//               const path = dirs.LegacyDownloadDir + `/save_img_${Math.random()}.png`;
//               imgSource = 'file:///' + path; // save path for Android
//               ReactNativeBlobUtil.fs.writeFile(path, Base64Code[1], 'base64')
//                   .then((res) =>
//                   {
//                       this.onDisplayNotification(path);
...
//               imgSource = this.props.imageUrls[this.state.currentShowIndex || 0].url;

//               CameraRoll.save(imgSource,{ type: 'photo', album: 'Downloads' })
//                   .then(res => Toast.show({
//                       autoHide: true,
//                       title: 'Success',
//                       type: 'success',
//                       message: 'Your Picture was save in Pictures folder.',
//                   }))
//                   .catch(err => console.error(err));
...
//                   {this.props.menus({ cancel: this.handleLeaveMenu, saveToLocal: this.saveToLocal,exit: this.handleCancel })}
//               </View>
//           );
//       }
...
//                   >
//                       <Text style={this.styles.operateText}>{this.props.menuContext.exit}</Text>
//                   </TouchableHighlight>
//               </View>
//           </View>
//       );
...
//                       <React.Fragment>
//                           <Pressable
//                               style={{ position: 'absolute',top: 20,right: 20,zIndex: 99999 }}
//                               onPress={()=>
//                               {
...
//                           </Pressable>
//                           <Pressable
//                               style={{ position: 'absolute',top: 20,right: 60,zIndex: 99999 }}
//                               onPress={()=>
//                               {
//                                   this.saveToLocal();
//                               }}
...
//                           </Pressable>
//                           <Pressable
//                               style={{ position: 'absolute',top: 20,left: 20,zIndex: 99999 }}
